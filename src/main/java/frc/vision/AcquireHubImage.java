...
public class AcquireHubImage  implements Runnable
{
  ...
  public void run() {
    ...
    {
      CameraServer.getInstance().startAutomaticCapture(TargetCamera);
    }
    ...
    MjpegServer intakeCameraServer = CameraServer.getInstance().addServer("IntakeServer");
...
// this json config scheme doesn't seem to work - I tried and failed
// String targetCameraConfig = "{\"Properties\": [{\"name\": \"white_balance_temperature\", \"value\": 4800 }]}";
//{"fps":30,"height":120,"name":"Intake","path":"/dev/v4l/by-path/platform-fd500000.pcie-pci-0000:01:00.0-usb-0:1.1:1.0-video-index0","pixel format":"mjpeg","stream":{"properties":[{"name":"compression","value":50}]},"white balance":3500,"width":160}
// var TargetCameraConfig = TargetCamera.getConfigJson();
// System.out.println(targetCameraConfig);
// TargetCamera.setConfigJson(targetCameraConfig);
// System.out.println(intakeCameraServer.getConfigJson());

// String IntakeCameraConfig = "{
//     \"fps\": 10,
//     \"height\": 120,
//     \"pixel format\": \"mjpeg\",
//     \"properties\": [
//         { \"name\": \"connect_verbose\", \"value\": 1 },
//         { \"name\": \"raw_brightness\", \"value\": 30 },
//         { \"name\": \"brightness\", \"value\": 0 },
//         { \"name\": \"raw_contrast\", \"value\": 5 },
//         { \"name\": \"contrast\", \"value\": 50 },
//         { \"name\": \"raw_saturation\", \"value\": 160 },
//         { \"name\": \"saturation\", \"value\": 80 },
//         { \"name\": \"white_balance_temperature_auto\", \"value\": true },
