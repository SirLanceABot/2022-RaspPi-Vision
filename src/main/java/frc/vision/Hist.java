 ...
 */
    ...
    Imgproc.putText(histImage, label[0], new Point(10, histH/3 - 2), Core.FONT_HERSHEY_SIMPLEX, 0.5, new Scalar(255, 255, 255), 1);
    Imgproc.putText(histImage, label[1], new Point(10, histH*2/3 - 2), Core.FONT_HERSHEY_SIMPLEX, 0.5, new Scalar(255, 255, 255), 1);
    Imgproc.putText(histImage, label[2], new Point(10, histH - 2), Core.FONT_HERSHEY_SIMPLEX, 0.5, new Scalar(255, 255, 255), 1);
